          ...
          <div className="d-flex flex-column justify-content-center ">
            <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                  ...
                  <p className='mb-3'>Save more today with Pradeep Readymade</p>
    ...
    <div className="row">
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">"Great collection and affordable prices! I found everything I needed for my family in one place. Highly recommended!".</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">"I love shopping at Pradeep Readymade. They have the latest designs, and the prices are budget-friendly."</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">"Pradeep Readymade offers stylish clothing at prices that don’t hurt your pocket. I’m a regular customer now!"</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">"From ethnic wear to party dresses, casual outfits, and formal wear, the variety here is unmatched. There’s something for everyone!".</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
